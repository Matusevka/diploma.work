...
final class Version20220628175222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649507CB2A9 FOREIGN KEY (tickspot_id) REFERENCES tickspot (id)');
        $this->addSql('CREATE INDEX IDX_8D93D649507CB2A9 ON user (tickspot_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649507CB2A9');
